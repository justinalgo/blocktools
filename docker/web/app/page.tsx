...
export default function Home() {
  ...
  return (
    <>
      <header>
        <div className="mx-auto max-w-7xl mb-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl font-bold leading-tight tracking-tight text-gray-900">Tools for Algorand</h1>
        </div>
      </header>
      <main>
        <div className="mx-auto max-w-7xl sm:px-6 lg:px-8">
          <div className="mx-auto max-w-7xl pt-6 pb-4">
            <h4 className="text-xl font-bold leading-tight tracking-tight text-gray-900">Asset Tools</h4>
          </div>
